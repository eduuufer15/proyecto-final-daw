...
-- NOTA: JPA convierte textoPregunta -> texto_pregunta automaticamente
-- ============================================

-- VERDADERO/FALSO (15 preguntas)

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Java es un lenguaje de programacion orientado a objetos', 1);
SET @id1 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id1, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Python fue creado por Guido van Rossum', 1);
SET @id2 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id2, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('HTML es un lenguaje de programacion', 2);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Java utiliza recoleccion de basura automatica', 3);
SET @id5 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id5, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('SQL significa Standard Query Language', 4);
SET @id6 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id6, 0);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Una base de datos relacional organiza datos en tablas', 4);
SET @id7 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id7, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('MySQL es un sistema gestor de bases de datos', 4);
SET @id8 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id8, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('El Real Madrid ha ganado mas Champions League que cualquier otro equipo', 5);
SET @id9 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id9, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Lionel Messi ha jugado en el FC Barcelona', 5);
SET @id10 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id10, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('En futbol se puede usar las manos', 5);
SET @id11 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id11, 0);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('El futbol se juega con 5 jugadores por equipo', 5);
SET @id12 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id12, 0);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('El Baloncesto se juega con 11 jugadores por equipo', 6);
SET @id13 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id13, 0);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('En baloncesto se puede botar el balon', 6);
SET @id14 = LAST_INSERT_ID();
INSERT INTO pregunta_verdadero_falso (id, respuesta_correcta) VALUES (@id14, 1);

INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('La NBA es una liga de baloncesto', 6);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Que es una variable en programacion?', 1);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('En que lenguaje esta escrito el sistema operativo Linux?', 1);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Que es HTML?', 1);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cual es el creador de Java?', 3);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Que significa JVM?', 3);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Que es SQL?', 4);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cual es un sistema gestor de bases de datos NoSQL?', 4);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Que tipo de relacion es cuando un registro de una tabla se relaciona con varios de otra?', 4);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuantos jugadores hay en un equipo de futbol en el campo?', 5);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Quien gano el mundial de futbol 2022?', 5);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('En que club juega actualmente Cristiano Ronaldo?', 5);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuantos jugadores hay en un equipo de baloncesto en la cancha?', 6);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Quien es considerado el mejor jugador de baloncesto de todos los tiempos?', 6);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuantos puntos vale una canasta desde fuera de la linea de tres puntos?', 6);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Que equipo de la NBA tiene mas campeonatos?', 6);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales de los siguientes son lenguajes de programacion?', 1);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales son tipos de datos primitivos en Java?', 3);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales son frameworks de Java?', 3);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales son comandos SQL?', 4);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales son bases de datos relacionales?', 4);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales jugadores han ganado el Balon de Oro?', 5);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales equipos han ganado la Champions League mas de 10 veces?', 5);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales son ligas importantes de futbol europeo?', 5);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales jugadores son leyendas de la NBA?', 6);
...
INSERT INTO pregunta (texto_pregunta, categoria_id) VALUES ('Cuales equipos pertenecen a la NBA?', 6);
